...
export default function Faq({ faqs, openId, onToggle }: FaqProps) {
  return (
    <section id="faq" className="w-full bg-[#fcfaf4] px-[var(--wc-mobile-nav-pad-x)] py-[clamp(2.5rem,7vw,3.75rem)] md:grid md:min-h-[50rem] md:grid-cols-[32.875rem_40.75rem] md:justify-center md:gap-x-[4.875rem] md:px-[7.375rem] md:pb-[4.75rem] md:pt-[9.375rem]">
      <div className="max-w-[32.875rem]">
        ...
        <h2 className="mt-[1.875rem] font-poppins text-[1.75rem] font-[200] leading-[2.375rem] text-[#697a61] md:text-[2.375rem] md:leading-[3.3125rem]">
          Thoughtful answers
          <br />
          ...
          return (
            <div key={faq.id} className="border-b border-b-[rgba(101,120,94,0.14)]">
              <button
                ...
                className="flex min-h-0 w-full items-center justify-between gap-4 py-4 text-left font-poppins text-[0.875rem] font-[400] leading-[1.4] text-[#65785e] md:min-h-[4.5rem] md:py-3 md:text-[1.25rem] md:font-[300]"
              >
              ...
              <AnimatePresence initial={false}>
                {isOpen && (
                  ...
                  >
                    <p className="pb-4 font-poppins text-[0.75rem] font-[200] leading-[1rem] text-[#65785e] whitespace-pre-line md:max-w-[33.25rem] md:pb-[1.125rem] md:text-[1rem] md:leading-[1.625rem] md:text-[rgba(101,120,94,0.9)]">
                      {faq.answer}
                    </p>
                  </motion.div>
                )}

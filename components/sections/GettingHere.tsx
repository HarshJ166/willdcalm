...
export default function GettingHere({ transport, mapSrc }: GettingHereProps) {
  ...
  return (
    <section
      id="getting-here"
      className="relative flex w-full flex-col gap-[clamp(1.75rem,5vw,2.5rem)] bg-[#f5f1e8] px-[var(--wc-mobile-nav-pad-x)] py-[clamp(3.75rem,11vw,4.5rem)] md:h-[50rem] md:flex-row md:items-start md:gap-32 md:px-[var(--wc-page-gutter)] md:py-[5.5625rem]"
    >
